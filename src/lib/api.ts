 ...
 * Endpoint: GET /dataset/detail?evolfid={evolfId}
 * @param evolfId - The EvOlf ID to fetch overview for
 * @returns Overview dataset entry information
 */
export async function fetchDatasetOverview(evolfId: string) {
  const url = `${API_CONFIG.BASE_URL}/dataset/detail?evolfid=${evolfId}`;
  console.log('API Request URL:', url);
  ...
  if (!response.ok) {
    throw new ApiError(`Failed to fetch dataset overview: ${response.statusText}`, response.status);
  }
...
/**
 * Fetch receptor data for a specific EvOlf ID
 * Endpoint: GET /dataset/receptor?evolfid={evolfId}
 * @param evolfId - The EvOlf ID to fetch receptor data for
 * @returns Receptor dataset entry information
 */
export async function fetchDatasetReceptor(evolfId: string) {
  const url = `${API_CONFIG.BASE_URL}/dataset/receptor?evolfid=${evolfId}`;
  console.log('API Request URL:', url);
  ...
  if (!response.ok) {
    throw new ApiError(`Failed to fetch dataset receptor: ${response.statusText}`, response.status);
  }
...
/**
 * Fetch ligand data for a specific EvOlf ID
 * Endpoint: GET /dataset/ligand?evolfid={evolfId}
 * @param evolfId - The EvOlf ID to fetch ligand data for
 * @returns Ligand dataset entry information
 */
export async function fetchDatasetLigand(evolfId: string) {
  const url = `${API_CONFIG.BASE_URL}/dataset/ligand?evolfid=${evolfId}`;
  console.log('API Request URL:', url);
  ...
  if (!response.ok) {
    throw new ApiError(`Failed to fetch dataset ligand: ${response.statusText}`, response.status);
  }
 ...
 * Endpoint: GET /dataset/interaction?evolfid={evolfId}
 * @param evolfId - The EvOlf ID to fetch interaction data for
 * @returns Interaction dataset entry information
 */
export async function fetchDatasetInteraction(evolfId: string) {
  const url = `${API_CONFIG.BASE_URL}/dataset/interaction?evolfid=${evolfId}`;
  console.log('API Request URL:', url);
  ...
  if (!response.ok) {
    throw new ApiError(`Failed to fetch dataset interaction: ${response.statusText}`, response.status);
  }
...
/**
 * Fetch structure data (PDB/SDF) for a specific EvOlf ID
 * Endpoint: GET /dataset/structures?evolfid={evolfId}
 * @param evolfId - The EvOlf ID to fetch structure data for
 * @returns Structure dataset entry information with PDB and SDF data
 */
export async function fetchDatasetStructures(evolfId: string) {
  const url = `${API_CONFIG.BASE_URL}/dataset/structures?evolfid=${evolfId}`;
  console.log('API Request URL:', url);
  ...
  if (!response.ok) {
    throw new ApiError(`Failed to fetch dataset structures: ${response.statusText}`, response.status);
  }
